...
owner=${1:-termux-pod}
repo=${2:-unstable-packages}
termux_repo=${3:-termux-unstable}
#dists=` echo ${3} | cut -d'-' -f2`
dists=${4:-unstable}
tag=deb
pkg_url="https://packages.termux.org/apt/termux-unstable/"
...
fetcher() {
	...
	curl -f  https://packages.termux.org/apt/${termux_repo}/dists/${dists}/main/binary-aarch64/Packages -Lo $aarch64
	curl -f  https://packages.termux.org/apt/${termux_repo}/dists/${dists}/main/binary-arm/Packages -Lo $arm
	curl -f  https://packages.termux.org/apt/${termux_repo}/dists/${dists}/main/binary-i686/Packages -Lo $i636
	curl -f  https://packages.termux.org/apt/${termux_repo}/dists/${dists}/main/binary-x86_64/Packages -Lo $x86
